...
| 역할 | 기본 업무 |
|---|---|
| 운영 관리자 | 회사 생성, 최초 회사 관리자 연결, 허용 모듈, 고른 회사의 사람·재고·자산·계약 |
...
운영 관리자와 회사 관리자의 권한은 구분한다. 운영 관리자는 멤버십을 자동으로 갖지 않는다. 등록된 회사를 고른 뒤에는 그 회사 지정 PC에서 사람·재고·자산·계약을 다룰 수 있다. 본사를 연 채 다른 회사 원본을 한 화면에 섞지 않는다. 최초 운영 관리자 권한은 서버의 별도 운영 절차로 부여하고, 일반 사용자가 가입·프로필 수정으로 자신에게 부여할 수 없게 한다. 상세는 D-32, `DOC/tenants.md`.
