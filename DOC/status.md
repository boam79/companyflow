...
마지막 갱신: 2026-09-22  
현재 역할: Executor  
회사 설정. 연 회사의 표시만 그 원본에 저장. 백업·복원은 열지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

`/settings`에서 이 PC가 연 회사를 고르면 그 회사 원본의 표시만 읽고 저장한다. 백업·복원은 열지 않는다.
...
- 표시 확인. 본사 원본은 세계시 12:40, 달러, 자리 구분 끔(12345). 회사마다 원본 파일이 다름. 백업·복원 화면은 없음. 복원은 T9
