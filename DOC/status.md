...
홈에 수령 대기·계약 기한(60일)·입사 중·재고 부족·최근 작업을 둔다. 결재·통계 메뉴는 넣지 않는다.
...
- 2026-09-20: 품목 최소재고와 홈 재고 부족. 결재·통계 없음.
...
- MST-01·02·03·05 품목코드·구매 구분·단위·비활성화·거래처 연락처 없음. MST-04 최소재고는 이번 배포. 지정 Chrome 확인 전.
