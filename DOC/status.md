...
마지막 갱신: 2026-09-22  
현재 역할: Executor  
회사 설정. 계약 메뉴 저장은 선택한 회사 파일에만 씀. 꺼진 회사는 계약 목록을 열지 않음. 백업·복원은 열지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

본사 계약 메뉴를 끈 뒤에도 목록이 열렸다. 회사를 바꾸는 동안 저장이 다른 회사 파일에 들어갔다. 저장 전에 선택한 회사 파일을 연다. 저장된 계약은 지우지 않는다. 본사는 계약 메뉴를 다시 끈 뒤 확인한다.
