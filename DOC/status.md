...
마지막 갱신: 2026-09-23  
현재 역할: Executor  
회사 설정은 연 회사의 사람과 표시만 연다. 다른 회사는 모듈만 켜고 끈다. 백업·복원은 열지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

본사를 연 회사 설정에서 다른 회사의 구매·재고·자산·입퇴사·계약 모듈을 켜고 끈다. 그 회사의 사람·재고·계약 내용은 열지 않는다. 끈 메뉴는 그 회사를 열었을 때 빠진다.
