...
지정 Chrome 거래처 연락처 확인됨. MST-01 품목 공급사. 결재·통계는 넣지 않는다.
...
- 2026-09-20: MST-01 품목에 공급사(거래처) 연결. 결재·통계 없음.
...
- MST-02·05 구매 구분 회사 추가·비활성화 UI 없음. MST-01 공급사·MST-03 연락처는 이번 배포. 지정 Chrome 확인 전.
