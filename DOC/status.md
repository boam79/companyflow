...
지정 Chrome 품목 합치기 확인됨. MST-03 거래처 연락처·메모·첨부. 결재·통계는 넣지 않는다.
...
- 2026-09-20: MST-03 거래처 명칭·연락처·메모·첨부. 공급사·계약 상대는 같은 목록. 결재·통계 없음.
...
- MST-01·02·05 공급사 연결·비활성화 UI 없음. MST-03 거래처 연락처·메모·첨부는 이번 배포. 지정 Chrome 확인 전.
