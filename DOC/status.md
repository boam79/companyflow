...
지정 Chrome PUR-03 발주일(2026-09-20) 확인됨. 발주 첨부·표 머리글 한 줄. 결재·다품목·통화·통계는 넣지 않는다.
...
- 2026-09-20: PUR-03 발주 첨부·표 머리글 한 줄. 지정 Chrome 발주일 확인 후.
...
- PUR-03 발주 공급사·납기·발주일은 지정 Chrome 확인. 첨부는 이번 배포. 통화·다품목·검수·취소·발주서 Template는 아직.
