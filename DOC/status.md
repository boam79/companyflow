...
A2 계정 삭제 시 그 사람이 관리하던 회사(지점)도 삭제.
...
- [ ] A2 계정 삭제 시 지점 중앙 등록도 삭제. 본사는 남김. 사용자 확인 전.
- [ ] A1 테스트 계정 삭제. 같은 이메일 재가입. 사용자 확인 전.
...
- 2026-09-24: A2 계정 삭제 시 회사 관리자인 회사(지점) 중앙 등록도 지움. 운영자가 멤버인 회사는 남김. 사용자 확인 전.
- 2026-09-24: A1 테스트 계정 삭제. 운영이 아닌 계정 헤더, 운영자는 회사 관리 이메일. 운영 계정은 막음. 배포 `8e9cd5f`. 사용자 확인 전.
