...
지정 Chrome PUR-04 확인. PUR-05 수령 정상·불량. 불량은 현재고·잔량에 넣지 않는다. 결재·반품·통계는 넣지 않는다.
...
- PUR-03 발주 공급사·납기·발주일·첨부·통화는 지정 Chrome 확인. PUR-04 다품목은 지정 Chrome 확인. 검수 정상·불량은 이번 배포. 반품·취소·발주서 Template는 아직.
- INV-01 불량은 가용 재고에 안 넣음. INV-02 검수 통과분 창고/자산/비재고 배분 분할은 아직. 정상 수령은 전량 창고 또는 자산.
