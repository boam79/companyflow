...
마지막 갱신: 2026-09-22  
현재 역할: Executor  
회사 설정. 계약 메뉴는 연 회사 원본에만 끈다. 백업·복원은 열지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

`/settings`에서 연 회사의 계약 메뉴를 끄면 그 회사 파일에만 남고, 위 메뉴에서 계약이 빠진다. 백업·복원은 열지 않는다.
...
- 두 카드 확인. 지점 서울 21:49·원·12,345. 본사 세계시 12:49·달러·12345. 계약 메뉴는 연 회사 파일.
- 백업·복원 화면은 없음. 복원은 T9
