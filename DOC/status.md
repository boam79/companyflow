...
지정 Chrome MST-02 사무용품 확인됨. PUR-03 발주 공급사(품목 기본·목록 표시). 결재·다품목·납기·통계는 넣지 않는다.
...
- 2026-09-20: PUR-03 발주 공급사(품목 기본·목록·CSV). 납기·다품목·결재 없음.
...
- PUR-03 발주 공급사는 이번 배포. 납기·통화·첨부·다품목·검수·취소·발주서 Template는 아직.
