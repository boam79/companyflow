...
지정 Chrome MST-05 확인됨. MST-02 구매 구분 회사 추가·이름 변경·사용 안 함. 결재·통계는 넣지 않는다.
...
- 2026-09-20: MST-02 구매 구분은 기본 일반 비품·자재·서비스에 회사 추가·이름 변경·사용 안 함. 결재·통계 없음.
...
- MST-02 구매 구분 회사 추가·이름 변경은 이번 배포. 지정 Chrome 확인 전.
