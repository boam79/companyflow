...
품목에 코드·단위를 둔다(MST-01 일부). 구매 구분·공급사·비활성화는 아직. 결재·통계 메뉴는 넣지 않는다.
...
- 2026-09-20: MST-01 품목코드·단위. 구매 구분·공급사 없음. 결재·통계 없음.
...
- MST-01·02·03·05 구매 구분·공급사·비활성화·거래처 연락처 없음. MST-01 품목코드·단위와 MST-04 최소재고는 이번 배포. 지정 Chrome 확인 전.
