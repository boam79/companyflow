...
마지막 갱신: 2026-09-24  
현재 역할: Executor  
회사는 서로 독립이다. 규칙은 [`tenants.md`](tenants.md). 운영 계정은 고른 회사의 사람·재고·자산·계약과 모듈을 다룬다. 본사를 연 채 다른 회사 원본을 섞지 않는다. 백업·복원은 열지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

독립 회사·운영 계정 규칙을 문서에 고정하고, 회사 관리에서 그 회사 업무를 연다.
...
- 2026-09-24: 독립 회사·운영 계정 규칙을 `DOC/tenants.md`에 고정(D-32). 회사 관리에서 그 회사 업무를 연다.
...
- AC-02·27 회사는 서로 독립. 운영 계정은 멤버십 없이 고른 회사 파일만 연다. 본사를 연 채 다른 회사 사람·재고를 섞지 않는다. [`tenants.md`](tenants.md), D-32.
