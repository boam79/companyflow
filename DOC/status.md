...
지정 Chrome 품목 공급사 확인됨. MST-05 기준정보는 삭제 대신 사용 안 함. 결재·통계는 넣지 않는다.
...
- 2026-09-20: MST-05 품목·부서·거래처·창고는 삭제 대신 사용 안 함. 결재·통계 없음.
...
- MST-02 구매 구분 회사 추가·이름 변경 없음. MST-05 사용 안 함은 이번 배포. 지정 Chrome 확인 전.
