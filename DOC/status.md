...
- [ ] A11 사용 가능이면 초기 설정 버튼 숨김. 사용자 확인 전.
- [ ] A10 초기 설정 같은 창 원본 재사용. 사용자 확인 전.
- [ ] A9 초기 설정 번호 로그 제거. 사용자 확인 전.
...
- 2026-09-25: A11 사용 가능이면 초기 설정 버튼을 숨긴다. 사용자 확인 전.
