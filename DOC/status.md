...
마지막 갱신: 2026-09-22  
현재 역할: Executor  
회사 사용자 초대. 수락 전 멤버십 없음. 메일은 보내지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

회사 관리 화면에서 이메일 초대를 남긴다. 수락 배너는 로그인한 그 계정에만 보인다. HTTPS 배포 후 로그인 확인을 요청한다.
...
- AC-33 사용자 초대. 수락 전 멤버십 없음. 메일 발송은 없음. 로그인 확인 전.
