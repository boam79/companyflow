...
마지막 갱신: 2026-09-24  
현재 역할: Executor  
회사는 서로 독립이다. 운영·본사 최고 관리자는 다른 회사 모듈만 켠다. 사람·재고·계약 원본은 열지 않는다. 백업·복원은 열지 않음. T7 완료 아님.  
원격: https://github.com/boam79/companyflow.git

## 지금 하는 일

운영 계정 업무 목록은 멤버로 연결된 회사만. 본사를 연 최고 관리자는 다른 회사 모듈만 켠다.
...
- AC-02·27 회사는 서로 독립. 운영 권한만으로는 다른 회사 원본을 열지 않음. 본사 최고 관리자는 다른 회사 모듈만 켬.
