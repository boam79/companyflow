...
지정 Chrome 품목에 복사용지가 두 줄이고 단위 칸이 라벨 없이 개로만 보인다. 같은 이름 추가를 막고, 코드·단위·최소재고·구매 구분 라벨을 단다. 결재·통계는 넣지 않는다.
...
- 2026-09-20: 지정 Chrome 품목 확인. 같은 이름 추가 차단, 코드·단위 라벨, MST-02 구매 구분. 결재·통계 없음.
...
- MST-01·02·03·05 공급사·비활성화·거래처 연락처 없음. MST-01 코드·단위, MST-02 구매 구분(일반 비품·자재·서비스), MST-04 최소재고는 이번 배포. 지정 Chrome 확인 전.
